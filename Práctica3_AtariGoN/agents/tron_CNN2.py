...
class TronGoshi(Goshi):
    ...
    try:
        policy_dqn.load_state_dict(torch.load('tron_cnn.pt', map_location=model_device))
    except:
        pass
    ...
    def optimize(self, mini_batch):
        ...
        torch.save(self.policy_dqn.state_dict(), "tron_cnn.pt")
